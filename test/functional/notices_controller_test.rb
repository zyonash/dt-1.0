...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, :notice => { :contact => @notice.contact, :description => @notice.description, :location => @notice.location, :name => @notice.name }
    end
  ...
  test "should update notice" do
    put :update, :id => @notice, :notice => { :contact => @notice.contact, :description => @notice.description, :location => @notice.location, :name => @notice.name }
    assert_redirected_to notice_path(assigns(:notice))
  end
